...
class HaiyyaUser extends Eloquent implements UserInterface, RemindableInterface {
        ...
        {
                return $this->belongsToMany('HaiyyaUser', 'connections', 'user_id', 'friends_id');
        }
        ...
        public static function getFromKey($key)
        {
                ...
                return HaiyyaUser::where('key', '=', $key)
                        ->first();
        }
